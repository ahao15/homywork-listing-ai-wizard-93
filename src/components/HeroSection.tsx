        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
              <span className="gradient-text">Homywork</span> — The AI Co-operator for Your Listings
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-homywork-purple hover:bg-homywork-purple/90 text-white">
                Start for Free <ArrowRight size={18} className="ml-2" />
              </Button>
              <Button size="lg" variant="outline" className="border-homywork-purple text-homywork-purple hover:bg-homywork-purple/10">
                Book a Demo <ChevronRight size={18} className="ml-1" />
              </Button>
            </div>
          </div>
          <div className="relative rounded-lg overflow-hidden shadow-2xl animate-fade-up" style={{ animationDelay: "0.2s" }}>
